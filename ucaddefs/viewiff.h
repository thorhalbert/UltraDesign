...
/*00*/	WORD		WitLayer;	/* Witness layer */
/*00*/	WORD		WitGroup;	/* Witness group */
/*00*/	WORD		WitPen;		/* Witness pen style */

/*00*/	WORD		DimLinLayer;	/* Dim Line Layer */
/*00*/	WORD		DimLinGroup;	/* Dimension Line Group */
/*00*/	WORD		DimLinPen;	/* Dim line pen style */

/*00*/	WORD		DimBoxStyle;	/* Text style of dim box */
/*00*/	WORD		DimBoxLayer;	/* Dim box layer */
/*00*/	WORD		DimBoxGroup;	/* Dim box group */
/*00*/	WORD		DimBoxPen;	/* Dim Box Pen */
